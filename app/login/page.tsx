    ...
    <div className="relative min-h-screen bg-[#050010] overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        ...
        >
          ...
          {serverError && (
            <div className="mb-4 p-3 bg-red-500/20 border border-red-500/50 rounded-lg text-red-200 text-sm text-center flex items-center justify-center gap-2">
              <AlertCircle size={16} />
              {serverError}
            </div>
          )}
          ...
          <div className="grid grid-cols-2 gap-4">
            <GoogleLoginButton className="flex items-center justify-center gap-2 h-11 rounded-lg border border-white/10 bg-white/5 text-white text-sm hover:bg-white/10 transition-all">
